<div class="app-sidebar-header d-flex flex-stack d-none d-lg-flex pt-8 pb-2" id="kt_app_sidebar_header">
    <!--begin::Logo-->
    <a style="margin-bottom: -10px;" href="<?= base_url('SplitScreen'); ?>" class="app-sidebar-logo">
        <img style="height: 50px!important;" alt="Logo" src="<?= base_url(); ?>demo38/svg/logo_tbk_mrt.svg" class="h-25px d-none d-sm-inline app-sidebar-logo-default theme-light-show" />
    </a>
